...
using Questao4.Models.Service;

namespace Questao4.Viewers
{
    public static class MenuOp
    {
        ...
        {
            new GenericMenuOption("Inserir Livro", LivroService.CadastrarLivro),
            new GenericMenuOption("Ver Livros", LivroService.VerLivros),
            new GenericMenuOption("Ver Maior & Menor Livro por Quantidade de Paginas", LivroService.MaiorMenorLivro)
        };
