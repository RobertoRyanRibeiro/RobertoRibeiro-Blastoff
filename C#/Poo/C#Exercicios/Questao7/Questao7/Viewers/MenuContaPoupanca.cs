...
{
    public static class MenuContaPoupanca
    {
        ...
        {
            new GenericMenuOption("Criar Conta",ContaPoupancaService.CriarConta),
            new GenericMenuOption("Calcular Rendimento",ContaPoupancaService.CalcularRendimento),
            new GenericMenuOption("Exibir Conta",ContaPoupancaService.ExibirConta),
