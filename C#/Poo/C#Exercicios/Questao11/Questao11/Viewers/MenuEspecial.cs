...
{
    public static class MenuEspecial
    {
        ...
        {
            new GenericMenuOption("Criar Contrato",EspecialService.CreateContract),
            new GenericMenuOption("Exibir Contrato",EspecialService.ShowContract),
            new GenericMenuOption("Calcular Prestação",EspecialService.CalculateContract),
