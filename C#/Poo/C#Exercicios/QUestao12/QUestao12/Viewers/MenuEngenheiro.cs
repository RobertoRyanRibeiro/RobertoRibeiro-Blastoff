...
using Controller;
using Generics;
using Questao12.Models.Service;

namespace Questao12.Viewers
{
    public static class MenuEngenheiro
    {
        ...
        {
            new GenericMenuOption("Criar Engenheiro",EngenheiroService.Create),
            new GenericMenuOption("Exibir Engenheiro",EngenheiroService.Show),
            new GenericMenuOption("Calcular Bonus",EngenheiroService.CalculateBonus),
