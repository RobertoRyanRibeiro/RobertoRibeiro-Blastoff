...
{
    public static class MenuGerente
    {
        ...
        {
            new GenericMenuOption("Criar Gerente",GerenteService.Create),
            new GenericMenuOption("Exibir Gerente",GerenteService.Show),
            new GenericMenuOption("Calcular Bonus",GerenteService.CalculateBonus),
