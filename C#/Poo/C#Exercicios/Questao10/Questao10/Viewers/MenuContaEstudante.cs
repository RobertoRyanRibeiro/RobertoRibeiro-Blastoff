...
using Controller;
using Generics;
using Questao10.Models.Service;

namespace Questao10.Viewers
{
    public static class MenuContaEstudante
    {
        ...
        {
            new GenericMenuOption("Conta",ContaEstudanteService.CreateCompra),
            new GenericMenuOption("Mostrar Conta",ContaEstudanteService.ShowCompra),
            new GenericMenuOption("Pagar Parcela",ContaEstudanteService.PagarParcela),
            new GenericMenuOption("Quitar Compra",ContaEstudanteService.QuitarCompra),
            new GenericMenuOption("Cancelar Compra",ContaEstudanteService.CancelarCompra),
            new GenericMenuOption("Renegociar Compra",ContaEstudanteService.RenegociarCompra),
            new GenericMenuOption("Especial",ContaEstudanteService.Especial),
        ...
        static void Head()
        {
            ...
            Console.WriteLine(" = Conta Estudante =");
