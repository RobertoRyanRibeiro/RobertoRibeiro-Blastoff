...
{
    public static class VisitantePremiumService
    {

        static VisitantePremium visitante;
        ...
        static void Entrada()
        {
            ...
            Console.WriteLine("========================================");
            var vale = int.Parse(Console.ReadLine());
            if (vale < 0)
                throw new ArgumentException("|Error - Numero do Vale não pode ser negativo");
            //=================================== CodTema =======================================
            Console.Clear();
            ...
            //=================================== Object =======================================
            visitante = new VisitantePremium(nome, cpf, data, codTema,vale);
        }
        ...
        public static void Comer()
        {
            ...
            if (visitante.Saldo == 0)
            {
                Console.WriteLine("| **Atenção** Você esta Pobre...");
                Thread.Sleep(1000);
                MenuVisitantePremium.View();
            }

            Console.Write("|Digite o valor que ira gastar:");
