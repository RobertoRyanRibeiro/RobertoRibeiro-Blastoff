...
using Controller;
using Generics;
using Questao9.Models.Service;

namespace Questao9.Viewers
{
    public static class MenuVisitantePremium
    {
        ...
        {
            new GenericMenuOption("Visitante Premium",VisitantePremiumService.CreateVisitante),
            new GenericMenuOption("Show Visitante",VisitantePremiumService.ShowVisitante),
            new GenericMenuOption("Comer",VisitantePremiumService.Comer),
            new GenericMenuOption("Calcular Itens",VisitantePremiumService.CalcularItens),
        ...
        static void Head()
        {
            ...
            Console.WriteLine(" = Visitante Premium =");
