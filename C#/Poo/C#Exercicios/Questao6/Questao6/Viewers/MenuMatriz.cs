...
namespace Questao6.Viewers
{
    public static class MenuMatriz
    {
        ...
        {
            new GenericMenuOption("Adicionar Valores",ArrayMatrizService.Add),
            new GenericMenuOption("Exibir Valores",ArrayMatrizService.Show),
            new GenericMenuOption("Soma",ArrayMatrizService.Sum),
            new GenericMenuOption("Maior & Menor",ArrayMatrizService.MajorAndMinor),
            new GenericMenuOption("Media",ArrayMatrizService.Media),
        ...
        static void Head()
        {
            ...
            Console.WriteLine(" =ArrayMatrizMenu=");
