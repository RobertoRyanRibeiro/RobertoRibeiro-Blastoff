...
{
    public static class MenuVisitante
    {
        ...
        {
            new GenericMenuOption("Visitante",VisitanteService.CreateVisitante),
            new GenericMenuOption("Show Visitante",VisitanteService.ShowVisitante),
            new GenericMenuOption("Calcular Itens",VisitanteService.CalcularItens),
