...
{
    public static class MenuCompra
    {
        ...
        {
            new GenericMenuOption("Conta",CompraService.CreateCompra),
            new GenericMenuOption("Mostrar Conta",CompraService.ShowCompra),
            new GenericMenuOption("Pagar Parcela",CompraService.PagarParcela),
            new GenericMenuOption("Quitar Compra",CompraService.QuitarCompra),
            new GenericMenuOption("Cancelar Compra",CompraService.CancelarCompra),
            new GenericMenuOption("Renegociar Compra",CompraService.RenegociarCompra),
