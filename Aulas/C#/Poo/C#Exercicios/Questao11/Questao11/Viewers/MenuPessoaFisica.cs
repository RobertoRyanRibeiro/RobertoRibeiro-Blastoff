...
{
    public static class MenuPessoaFisica
    {
        ...
        {
            new GenericMenuOption("Criar Contrato",PessoaFisicaService.CreateContract),
            new GenericMenuOption("Exibir Contrato",PessoaFisicaService.ShowContract),
            new GenericMenuOption("Calcular Prestação",PessoaFisicaService.CalculateContract),
