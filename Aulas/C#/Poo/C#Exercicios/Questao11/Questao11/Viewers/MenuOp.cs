...
namespace Questao11.Viewers 
{
    public static class MenuOp
    {
        ...
        {
            new GenericMenuOption("Contrato Pessoa Fisica",MenuPessoaFisica.View),
            new GenericMenuOption("Contrato Pessoa Juridica",MenuPessoaJuridica.View),
            new GenericMenuOption("Contrato Extra",MenuEspecial.View)
        };
