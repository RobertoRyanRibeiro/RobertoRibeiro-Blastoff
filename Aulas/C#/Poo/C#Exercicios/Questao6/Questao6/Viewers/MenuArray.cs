...
namespace Questao6.Viewers
{
    public static class MenuArray
    {
        ...
        {
            new GenericMenuOption("Adicionar Valores",ArrayService.Add),
            new GenericMenuOption("Exibir Valores",ArrayService.Show),
            new GenericMenuOption("Exibir Valores(Int)",ArrayService.ShowInt),
            new GenericMenuOption("Multiplicar",ArrayService.Mult),
