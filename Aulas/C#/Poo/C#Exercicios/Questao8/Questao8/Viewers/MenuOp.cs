...
using Controller;
using Generics;
using Questao8.Models.Service;

namespace Questao8.Viewers 
{
    public static class MenuOp
    {
        ...
        {
            new GenericMenuOption("Criar Automovel",AutomoveisService.CreateAutomovel),
            new GenericMenuOption("Ver Automovel",AutomoveisService.ShowAutomovel),
            new GenericMenuOption("Criar Automovel de Luxo",AutomoveisService.CreateAutomovelLuxo),
            new GenericMenuOption("Ver Automovel de Luxo",AutomoveisService.ShowAutomoveLuxo)
        };
